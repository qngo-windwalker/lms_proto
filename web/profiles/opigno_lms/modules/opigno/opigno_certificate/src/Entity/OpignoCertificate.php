 ...
 *     },
 *   },
 *   field_ui_base_route = "entity.opigno_certificate",
...
class OpignoCertificate extends EditorialContentEntityBase implements OpignoCertificateInterface {
  ...
  public function preSave(EntityStorageInterface $storage) {
    ...
    // If no revision author has been set explicitly, make the opigno_certificate owner
    // the revision author.
  ...
  public function preSaveRevision(EntityStorageInterface $storage, \stdClass $record) {
    ...
    if (!$this->isNewRevision() && isset($this->original) && (!isset($record->revision_log) || $record->revision_log === '')) {
      // If we are updating an existing opigno_certificate without adding a new revision, we
