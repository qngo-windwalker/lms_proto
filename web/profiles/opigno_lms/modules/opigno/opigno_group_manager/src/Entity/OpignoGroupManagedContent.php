...
class OpignoGroupManagedContent extends ContentEntityBase {
   ...
   *
   * @param int $group_id The learning path group ID.
   * @param string $group_content_type_id The content type plugin ID.
  ...
  /**
   * @return string The group content type plugin ID.
   */
  ...
  /**
   * @param string $group_content_type_id The group content type plugin ID.
   * @return $this
   */
   ...
   *
   * @param $group_id int The Group entity ID.
   ...
   *
   * @return bool|OpignoGroupManagedContent FALSE if no next content. The next OpignoGroupManagedContent if there is a next content.
   * @throws InvalidPluginDefinitionException
   */
