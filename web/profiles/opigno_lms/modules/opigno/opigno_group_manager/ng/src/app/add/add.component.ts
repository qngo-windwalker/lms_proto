...
export class AddComponent implements OnInit {
  ...
  addEntityToLearningPath(entity: Entity): void {
    ...
    setTimeout(function() {
      ...
      let childPosition = that.entityService.getNewChildPosition(that.selectedEntity, that.entities, that.entitiesPositions);
  ...
  getAddForm(): void {
    this.entityForm = this.sanitizer.bypassSecurityTrustResourceUrl(this.apiBaseUrl + this.appService.replaceUrlParams(this.getEntityFormUrl, { '%groupId': this.groupId, '%bundle': this.form.bundle, '%entityId': '' }));
