  ...
  traceLinks(entities, links, entityPositions): void {
    ...
    entities.forEach((entity) => {
      entity.parents.forEach((_parent) => {
        ...
        link.top = (globals.gridY / 2) + (globals.gapY * (this.getEntityPosition(parent, entityPositions).row - 1)) + (globals.gridY * (this.getEntityPosition(parent, entityPositions).row - 1)) + 'px';
        link.height = (this.getEntityPosition(entity, entityPositions).row - this.getEntityPosition(parent, entityPositions).row) * (globals.gapY + globals.gridY) + 'px';
        ...
        if (leftCol == rightCol && topRow - 1 == bottomRow) {
          svgPath = 'M' + (globals.linkWidth / 2 + globals.boxRadius) + ',0' +
            'L' + (globals.linkWidth / 2 + globals.boxRadius) + ',' + (this.getEntityPosition(entity, entityPositions).row - this.getEntityPosition(parent, entityPositions).row) * (globals.gapY + globals.gridY);
        }
        /** Same column and direct path */
          ...
          svgPath = 'M' + (globals.linkWidth / 2 + globals.boxRadius) + ',0' +
            'L' + (globals.linkWidth / 2 + globals.boxRadius) + ',' + (globals.gridY + globals.gapY) / 2 +
            'L' + (parseInt(link.width) - (globals.gridX + globals.boxRadius * 2 + globals.gapX + globals.linkWidth) / 2) + ',' + (globals.gridY + globals.gapY) / 2 +
            'L' + (parseInt(link.width) - (globals.gridX + globals.boxRadius * 2 + globals.gapX + globals.linkWidth) / 2) + ',' + (parseInt(link.height) - (globals.gridY + globals.gapY) / 2) +
            'L' + (parseInt(link.width) - (globals.boxRadius * 2 + globals.linkWidth) / 2) + ',' + (parseInt(link.height) - (globals.gridY + globals.gapY) / 2) +
          ...
          svgPath = 'M' + (globals.linkWidth / 2 + globals.boxRadius) + ',' + parseInt(link.height) +
            'L' + (globals.linkWidth / 2 + globals.boxRadius) + ',' + (parseInt(link.height) - (globals.gridY + globals.gapY) / 2) +
            'L' + (parseInt(link.width) - globals.linkWidth - (globals.gridX + globals.boxRadius * 2 + globals.gapX - globals.linkWidth) / 2) + ',' + (parseInt(link.height) - (globals.gridY + globals.gapY) / 2) +
            'L' + (parseInt(link.width) - globals.linkWidth - (globals.gridX + globals.boxRadius * 2 + globals.gapX - globals.linkWidth) / 2) + ',' + (globals.gridY + globals.gapY) / 2 +
            'L' + (parseInt(link.width) - (globals.boxRadius * 2 + globals.linkWidth) / 2) + ',' + (globals.gridY + globals.gapY) / 2 +
        ...
        if (entity.parents.length == 1) {
          link.yBox = parseInt(link.height) - globals.gridY / 2 - globals.boxRadius * 2 - globals.linkWidth - globals.boxMargin;
        } else {
          link.yBox = ((globals.gapY + globals.gridY) / 2) - globals.boxRadius * 2 - globals.linkWidth - globals.boxMargin;
        }
        ...
        // Triangle
        link.yTriangle = parseInt(link.height) - (globals.gridY / 2) - globals.linkWidth;
