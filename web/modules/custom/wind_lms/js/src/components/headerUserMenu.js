        ...
        <nav className="my-2 my-md-0 mr-md-3 p-2">
          <div className="user-block ml-3 dropdown">
            <a href="/user/1" className="d-flex align-items-center" data-toggle="dropdown" aria-expanded="false">
              Hi,  <CurrentUser isLogin={this.state.isLogin} /> &nbsp; <i className="fas fa-user-circle"> </i> <i className="fas fa-sort-down"></i>
            </a>
            <div className="dropdown-menu dropdown-menu-right"
              ...
              <div className="info list-group list-group-flush">
                <p className="list-group-item"><strong className="text-uppercase"><CurrentUser isLogin={this.state.isLogin} /></strong></p>
