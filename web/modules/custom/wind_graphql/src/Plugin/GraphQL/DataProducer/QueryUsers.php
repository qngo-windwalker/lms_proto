 ...
 * @DataProducer(
 *   id = "query_users",
 *   name = @Translation("Load users"),
 *   description = @Translation("Loads a list of users."),
 ...
 * )
 */
class QueryUsers extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
