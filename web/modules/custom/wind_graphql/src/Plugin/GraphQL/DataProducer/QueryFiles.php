 ...
 * @DataProducer(
 *   id = "query_files",
 *   name = @Translation("Load files"),
 *   description = @Translation("Loads a list of files."),
 *   produces = @ContextDefinition("any",
 *     label = @Translation("File connection")
 *   ),
 *   consumes = {
 ...
 * )
 */
class QueryFiles extends DataProducerPluginBase implements ContainerFactoryPluginInterface {
   ...
   *
   * @return \Drupal\wind_graphql\Wrappers\QueryConnection
